...
def process_markdown_list_into_dictionary(path, current_dictionary):
...
def get_known_urls(existing_path):
    ...
    for filename in all_files:
        if filename.endswith(".md"):
            ...
            known_urls = process_markdown_list_into_dictionary(full_path, known_urls)
